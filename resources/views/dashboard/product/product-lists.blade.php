                        ...
                        <div class="table-responsive">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-150px sorting">Campaign Status</th>
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td>
                                            ...
                                            @if ($product->status == 'unpublished')
                                                <div class="badge badge-light-danger">{{ Str::title($product->status) }}</div>
                                            @else
                                                <div class="badge badge-light-success">{{ Str::title($product->status) }}</div>
                                            @endif
                                            <!--end::Badges-->
                                        </td>
                                        <td>
